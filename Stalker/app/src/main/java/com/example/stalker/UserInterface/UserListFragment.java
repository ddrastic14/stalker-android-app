...
import com.example.stalker.adapters.UserRecyclerAdapter;
import com.example.stalker.models.ClusterMarker;
import com.example.stalker.models.PolylineData;
import com.example.stalker.models.User;
import com.example.stalker.models.UserLocation;
import com.example.stalker.utilities.MyClusterManagerRenderer;
import com.example.stalker.utilities.ViewWeightAnimationWrapper;
...
import static com.example.stalker.Constants.MAPVIEW_BUNDLE_KEY;
        ...
        if(mGoogleMap != null){
            ...
            for(UserLocation userLocation: mUserLocations){
                ...
                try{
                    ...
                    int avatar = R.drawable.darth_vader; // set the default avatar
                    try{
...
//                        Log.d(TAG, "run: latlng: " + latLng.toString());
    ...
    public void onPolylineClick(Polyline polyline) {
        ...
        for(PolylineData polylineData: mPolylinesData){
            ...
            if(polyline.getId().equals(polylineData.getPolyline().getId())){
                ...
                Marker marker = mGoogleMap.addMarker(new MarkerOptions().position(endLocation).title("Trip: #" + index).snippet("Duration: "+polylineData.getLeg().duration));
    ...
    @Override
    public void onUserClcked(int position) {

        Log.d(TAG, "onUserClicked: select a user: "+mUserList.get(position).getUser_id());
